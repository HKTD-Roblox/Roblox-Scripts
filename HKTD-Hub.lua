...
if executor then
    ...
    if isExecutorSupported then
        ...
        game.Players.LocalPlayer:Kick("Not supported Executor!")
    end
end
...
local Tabs = {
    ...
    Door = Window:AddTab({ Title = "Doors", Icon = "" }),
...
Tabs.All:AddButton({
    ...
    Tabs.All:AddButton({
        Title = "Aimbot",
        Description = "Make By ArceusX Aim",
        Callback = function()
